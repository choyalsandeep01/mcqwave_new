...
def process_docx_file(file_path):
    ...
    try:
            ...
            if '|' in text:
                ...
                try:
                    ...
                    mcq_content = {
                        ...
                        'paragraphs': [p.text for p in mcq_paragraphs]
                    }
        ...
        # Save document with uploaded content
